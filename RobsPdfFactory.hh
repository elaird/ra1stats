...
void AddModel_Lin_Combi(Double_t* BR,
  ...
  void AddModel_Exp_Combi_both_one(Double_t d_signal_sys,Double_t muon_sys,Double_t phot_sys,Int_t nbins,RooWorkspace* ws,const char* pdfName,const char* muName);
