...
def dev():
    ...
    return [
        ...
        scan(dataset="T2tt", had="v5", aT={200:"0.65",275:"0.6",325:"0.55"}, whiteList=["0b_le3j","0b_ge4j","1b_ge4j","1b_le3j", "2b_le3j",
                                                                                        "2b_ge4j","3b_ge4j","3b_le3j","ge4b_ge4j"], extraVars=["SITV"], **new),
