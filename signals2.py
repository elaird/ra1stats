...
t1 = common.signal(xs = 0.433971, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T1")["text"]),
...
t2 = common.signal(xs = 0.244862, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
t2bb = common.signal(xs = 0.0855847, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2bb")["text"]),
...
t2tt = common.signal(xs = 0.35683, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2tt")["text"]),
...
t1tttt = common.signal(xs = 0.0966803, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T1tttt")["text"]),
...
t1bbbb = common.signal(xs = 0.060276, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T1bbbb")["text"]),
