...
t1 = common.signal(xs = 1.0, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T1")["text"]),
...
t2 = common.signal(xs = 1.0, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
                                                                                           "(m_{#tilde{g}}= 600 GeV, m_{#tilde{#chi}^{0}_{1}} = 250 GeV)"))
t2.insert("0b_le3j",{"effHad":[0.012000, 0.017700, 0.054700, 0.048300, 0.022800, 0.010100, 0.002700, 0.002400],})


t2bb = common.signal(xs = 1.0, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2bb")["text"]),
                                                                                             "(m_{#tilde{g}}= 500 GeV, m_{#tilde{#chi}^{0}_{1}} = 150 GeV)"))
...
t2tt = common.signal(xs = 1.0, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2tt")["text"]),
                                                                                                 "(m_{#tilde{g}}= 400 GeV, m_{#tilde{#chi}^{0}_{1}} = 0 GeV)"))

template.insert("1b_ge4j", {"effHad" :[0.000700, 0.002040, 0.007820, 0.014240, 0.012180, 0.006900, 0.003560, 0.002440],
...
t1tttt = common.signal(xs = 1.0, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T1tttt")["text"]),
...
t1bbbb = common.signal(xs = 1.0, effUncRel = 0.14, label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T1bbbb")["text"]),
