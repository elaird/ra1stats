...
void RobsPdfFactory::AddModel_Exp_Combi_both_one(Double_t d_signal_sys,Double_t muon_sys,Double_t phot_sys,Int_t nbins,RooWorkspace* ws,const char* pdfName,const char* muName){
  ...
  //background at alphaT < 0.55 in 3 HT bins
  RooProduct* bkgd_bar_1 = new RooProduct("bkgd_bar_1","bkgd_bar_1",RooArgSet(*tau_1,*bbar,*rho,*rho));
  RooProduct* bkgd_bar_2 = new RooProduct("bkgd_bar_2","bkgd_bar_2",RooArgSet(*bbar,*tau_2,*rho));
  RooProduct* bkgd_bar_3 = new RooProduct("bkgd_bar_3","bkgd_bar_3",RooArgSet(*bbar));
  ...
  RooAddition* bkgd_3 = new RooAddition("bkgd_3","bkgd_3",RooArgSet(*b));
