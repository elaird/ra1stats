...
far10 = common.signal(xs=36.8*pb, effUncRel=0.20, nEventsIn=544137.76942,
                     label="#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2cc")["text"]),
                                                               "(m_{#tilde{t}}= 175 GeV, m_{#tilde{#chi}^{0}_{1}} = 95 GeV)"))
...
far10.insert("0b_le3j", {"effHad":[0.002184054054655644, 0.0013088108379180113, 0.0005939471613180906, 0.00045827244882640597, 0.0001298435613933683, 
                         ...
                         "sumWhadRelUnc":[0.02900773856164532, 0.037472021510685405, 0.05562520934994151, 0.06332623814515242, 0.11896942279727366, 
                                   0.2346152322075721, 0.34180606771574196, 0.6746703792402705, 0.7071067811865475, 0.8775269221188181, 1.1512624123394903],
                         "sumWhadRelErr":[0.026613320635287662, 0.03439794752927844, 0.05120869649165672, 0.055298201498170746, 0.11018880681357598, 
                                   0.19796148496525598, 0.28382583751394136, 0.5837593189113944, 0.7071067811865475, 0.7160825219899221, 1.0000008205851152]})
