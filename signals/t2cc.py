...
qcdLike = point(xs=36.8, effUncRel=0.20, label="SM + QCD-like (k=0.03)")
qcdLike.insert("0b_le3j", {"effHad":[effQcdLike(k=0.03, eff0=0.005, iBin=i) for i in range(8)]})

far8 = point(xs=36.8*pb, effUncRel=0.20,
...
near8 = point(xs=36.8*pb, effUncRel=0.20,
                      label="#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2cc")["text"]),
...
near10 = point(xs=36.8*pb, effUncRel=0.20,
                      label="#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2cc")["text"]),
                                                                "(m_{#tilde{t}}= 175 GeV, m_{#tilde{#chi}^{0}_{1}} = 165 GeV)"))
...
far10 = point(xs=36.8*pb, effUncRel=0.20, sumWeightIn=544137.76942,
                     label="#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2cc")["text"]),
                                                               "(m_{#tilde{t}}= 175 GeV, m_{#tilde{#chi}^{0}_{1}} = 95 GeV)"))
...
testMcUnc1 = point(xs=36.8*pb, effUncRel=0.20, sumWeightIn=543781, x=175.0, y=95.0, sigMcUnc=True)
