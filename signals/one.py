...
t1bbbb_1 = point(xs = 0.0101744, effUncRel = 0.160, lineStyle = 5,
...
t2tt_1 = point(xs = 0.0452067, effUncRel = 0.139, label = "T2tt m_{st} = 550 GeV; m_{LSP} = 20 GeV (xs = 45 fb)")
...
t2tt_2 = point(xs = 0.305512, effUncRel = 0.139, label = "T2tt m_{st} = 410 GeV; m_{LSP} = 20 GeV (xs = 305 fb)")
...
t2tt_3 = point(xs = 0.262683, effUncRel = 0.139, label = "T2tt m_{st} = 420 GeV; m_{LSP} = 20 GeV (xs = 262 fb)")
...
t2bb = point(xs = 0.0452067, effUncRel = 0.131, lineColor = r.kRed+1, lineStyle = 7,
...
effUncRelOld = 0.13
t2bb_2 = point(xs = 0.0486, effUncRel = effUncRelOld,
...
t1 = point(xs = 0.0651, effUncRel = effUncRelOld,
...
t1tttt_2012 = point(xs=0.0243547, effUncRel = effUncRelOld,
...
t1tttt_2012_2 = point(xs=0.157399, effUncRel = effUncRelOld,
...
t1tttt_2012_23 = point(xs=0.157399, effUncRel = effUncRelOld,
                               label = "#lower[0.35]{#splitline{SM + SUSY  ( %s )}{(m_{gluino} = 800 GeV, m_{LSP} = 100 GeV)}}"%t1ttttLabel)
...
t1tttt_2012_3 = point(xs=0.157399, effUncRel = effUncRelOld,
                              label = "#lower[0.35]{#splitline{SM + SUSY  ( %s )}{(m_{gluino} = 800 GeV, m_{LSP} = 100 GeV)}}"%t1ttttLabel)
