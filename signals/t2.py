...
a = point(xs = 0.8*0.244862, effUncRel = 0.134,
...
a_0 = point(xs = 0.244862, effUncRel = 0.134,
                   label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
b = point(xs = 0.8*0.0473374, effUncRel = 0.134,
                     label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
c = point(xs = 0.1*1.67947, effUncRel = 0.134,
                      label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
d = point(xs = 0.1*7.98294, effUncRel = 0.134,
                      label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
e = point(xs = 0.1*3.54338, effUncRel = 0.134,
                      label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
f = point(xs = 0.1*3.54338, effUncRel = 0.134,
                      label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
g = point(xs = 0.1*5.26422, effUncRel = 0.134,
                      label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
...
h = point(xs = 0.1*5.26422, effUncRel = 0.134,
                      label = "#lower[0.25]{#splitline{%s}{%s}}"%("SM + "+pruned(processStamp("T2")["text"]),
