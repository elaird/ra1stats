...
t1 = point(xs = 0.433971, effUncRel = 0.140,
...
t2bb = point(xs = 0.0855847, effUncRel = 0.131,
...
t2tt = point(xs = 0.35683, effUncRel = 0.139,
...
t1tttt = point(xs = 0.0966803, effUncRel = 0.230,
...
t1bbbb = point(xs = 0.060276, effUncRel = 0.160,
