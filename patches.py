...
def graphBlackLists() :
    ...
    out["ExpectedUpperLimit_-1_Sigma"].update({"T1": [(1150,425), (1100,300), (1100,350), (1100,375), (875, 550),
                                               ...
                                               "T2bb":[(450,250), (500,275), (550,275), (575,275), (600,275),
                                                       ],
                                               })
    ...
    out["ExpectedUpperLimit_+1_Sigma"].update({"T1": [(1000,450), (700,475), (775,500), (725,500), (700,525),
                                               ...
                                               "T2bb": [(600,200), (400,200), (525,200),
                                                        ],
                                               "T1bbbb": [(1225,500), (1200,150)
                                                          ],
                                               })
    ...
    out["UpperLimit_-1_Sigma"].update({"T1": [(700,475), (675,475), (625,450),
                                       ...
                                       "T2bb": [(425,200), (500,225), (400,200), (550,200),
                                                ],
                                       })
...
def graphReplacePoints():
    ...
    out["UpperLimit_-1_Sigma"].update({"T2bb":{(600,125):(605,125),
                                               (575,175):(575,185),
                                               (450,225):(450,212.5),
                                               (475,225):(475,212.5),
                                               (525,200):(530,210),
    ...
    out["UpperLimit_+1_Sigma"].update({"T2bb":{(475,250):(475,245),
                                               (500,250):(500,245),
                                               (550,250):(550,245),
                                               (575,250):(575,242),
                                               (675,75):(670,70),
