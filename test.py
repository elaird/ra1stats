#!/usr/bin/env python
import ROOT as r
import common,workspace,likelihoodSpec,signals2,plotting

def go(whiteList=[], dataset="", ensemble=False, allCategories=[], ignoreHad=False):
    ...
    nToys = {"":0, "2010":300, "2011eps":300, "2011":3000,
             "2012ichep":1000, "2012hcp":300, "2012hcp2":300, "2012dev":300}[dataset]
...
kargs = {"dataset" : ["", "2010", "2011eps", "2011", "2012ichep", "2012hcp", "2012hcp2", "2012dev"][-2],
         "ensemble": False,
         }
