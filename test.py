...
def signal(i) :
    ...
    p_33_53 = common.signal(xs = 0.050740907, label = "m_{0}=320 GeV, m_{1/2}=520 GeV (NLO)")
    p_33_53.insert("52", {
    ...
    return [{}, p_33_53, p_181_19, p_181_29, p_181_29b, t2tt, lm6, t1_600_100, t2_39_7][i]
